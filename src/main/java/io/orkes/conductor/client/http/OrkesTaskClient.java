...
public class OrkesTaskClient extends TaskClient implements AutoCloseable {
  ...
  public void updateTask(
      String workflowId, String taskReferenceName, TaskResult.Status status, Object output) {
    ...
    taskResourceApi.updateTaskByRefName(
        outputMap, workflowId, taskReferenceName, status.toString());
  }

  /**
   * Update the task status and output based given workflow id and task reference name and return
   * back the updated workflow status
   *
   * @param workflowId Workflow Id
   * @param taskReferenceName Reference name of the task to be updated
   * @param status Status of the task
  ...
  public Workflow updateTaskSync(
    ...
    return taskResourceApi.updateTaskSync(
        outputMap, workflowId, taskReferenceName, status.toString());
  }
