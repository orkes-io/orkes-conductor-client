...
public class EventResourceApi {
  ...
  private com.squareup.okhttp.Call deleteQueueConfigValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        deleteQueueConfigCall(queueType, queueName, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call getEventHandlersValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = getEventHandlersCall(progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call getEventHandlersForEventValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getEventHandlersForEventCall(event, activeOnly, progressListener, progressRequestListener);
    return call;
  }
  ...
  public List<EventHandler> getEventHandlersForEvent(String event, Boolean activeOnly)
      throws ApiException {
    ApiResponse<List<EventHandler>> resp = getEventHandlersForEventWithHttpInfo(event, activeOnly);
    return resp.getData();
  }
   ...
   *     response body
   */
  public Map<String, Object> getQueueConfig(String queueType, String queueName)
      throws ApiException {
   ...
   *     response body
   */
  private ApiResponse<Map<String, Object>> getQueueConfigWithHttpInfo(
      String queueType, String queueName) throws ApiException {
    com.squareup.okhttp.Call call =
  ...
  private com.squareup.okhttp.Call getQueueNamesValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = getQueueNamesCall(progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call putQueueConfigValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        putQueueConfigCall(body, queueType, queueName, progressListener, progressRequestListener);
    return call;
  }
  ...
  public com.squareup.okhttp.Call removeEventHandlerStatusCall(
    ...
    // create path and map variables
    String localVarPath =
        "/event/{name}".replaceAll("\\{" + "name" + "\\}", apiClient.escapeString(name.toString()));
   ...
   *     response body
   */
  private ApiResponse<Void> removeEventHandlerStatusWithHttpInfo(String name) throws ApiException {
    com.squareup.okhttp.Call call = removeEventHandlerStatusValidateBeforeCall(name, null, null);
    return apiClient.execute(call);
  }
