...
public class WorkflowBulkResourceApi {
  ...
  private com.squareup.okhttp.Call terminateValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        terminateCall(
            workflowIds, reason, triggerFailureWorkflow, progressListener, progressRequestListener);
    return call;
  }
  ...
  public BulkResponse terminate(
    ...
    ApiResponse<BulkResponse> resp =
        terminateWithHttpInfo(workflowIds, reason, triggerFailureWorkflow);
    return resp.getData();
  }
   ...
   *     response body
   */
  private ApiResponse<BulkResponse> terminateWithHttpInfo(
      List<String> workflowIds, String reason, boolean triggerFailureWorkflow) throws ApiException {
    com.squareup.okhttp.Call call =
