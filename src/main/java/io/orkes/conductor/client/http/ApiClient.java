...
public class ApiClient {
     ...
     * requests. Default to
     * true. NOTE: Do NOT set to false in production code, otherwise you would face
     * multiple types
     ...
     * with file
     * response. The default value is <code>null</code>, i.e. using the system's
     * default tempopary
     * folder.
     *
     * @see <a href=
    ...
    public String getNewToken() throws Exception {
        ...
        GenerateTokenRequest generateTokenRequest = new GenerateTokenRequest().keyId(this.keyId)
    ...
    void setTokenHeader() throws Exception {
        ApiKeyAuth apiKeyAuth = new ApiKeyAuth("header", "X-Authorization");
        apiKeyAuth.setApiKey(this.getNewToken());
        authentications.put("api_key", apiKeyAuth);
    }
}
