...
public class WorkflowResourceApi {
  ...
  public WorkflowRun executeWorkflow(
      ...
      throws ApiException {
    ApiResponse<WorkflowRun> resp =
        executeWorkflowWithHttpInfo(
            req, name, version, waitUntilTaskRef, requestId, waitForSeconds);
    return resp.getData();
  }
  ...
  public com.squareup.okhttp.Call decideCall(
    ...
    String localVarPath =
        "/workflow/decide/{workflowId}"
            .replaceAll(
                "\\{" + "workflowId" + "\\}", apiClient.escapeString(workflowId.toString()));
  ...
  public com.squareup.okhttp.Call deleteCall(
    ...
    if (archiveWorkflow != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("archiveWorkflow", archiveWorkflow));
  ...
  private com.squareup.okhttp.Call getExecutionStatusValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getExecutionStatusCall(workflowId, includeTasks, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     response body
   */
  public Workflow getExecutionStatus(String workflowId, Boolean includeTasks) throws ApiException {
  ...
  private ApiResponse<ExternalStorageLocation> getExternalStorageLocationWithHttpInfo(
      String path, String operation, String payloadType) throws ApiException {
    com.squareup.okhttp.Call call =
        getExternalStorageLocationValidateBeforeCall(path, operation, payloadType, null, null);
  ...
  public com.squareup.okhttp.Call getRunningWorkflowCall(
    ...
    List<Pair> localVarQueryParams = new ArrayList<Pair>();
    List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
    if (version != null) localVarQueryParams.addAll(apiClient.parameterToPair("version", version));
    if (startTime != null)
  ...
  private com.squareup.okhttp.Call getRunningWorkflowValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getRunningWorkflowCall(
            name, version, startTime, endTime, progressListener, progressRequestListener);
    return call;
  }
  ...
  public com.squareup.okhttp.Call getWorkflowStatusSummaryCall(
    ...
    if (includeVariables != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("includeVariables", includeVariables));
  ...
  private com.squareup.okhttp.Call getWorkflowStatusSummaryValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getWorkflowStatusSummaryCall(
            workflowId, includeOutput, includeVariables, progressListener, progressRequestListener);
    return call;
  }
  ...
  public WorkflowStatus getWorkflowStatusSummary(
      String workflowId, Boolean includeOutput, Boolean includeVariables) throws ApiException {
  ...
  private com.squareup.okhttp.Call getWorkflowsValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getWorkflowsCall(
            body, name, includeClosed, includeTasks, progressListener, progressRequestListener);
    return call;
  }
  ...
  public com.squareup.okhttp.Call getWorkflows1Call(
    ...
    String localVarPath =
        "/workflow/{name}/correlated/{correlationId}"
            .replaceAll("\\{" + "name" + "\\}", apiClient.escapeString(name.toString()))
            .replaceAll(
                "\\{" + "correlationId" + "\\}", apiClient.escapeString(correlationId.toString()));
  ...
  public Map<String, List<Workflow>> getWorkflowsByNamesAndCorrelationIds(
      CorrelationIdsSearchRequest request, Boolean includeClosed, Boolean includeTasks)
      throws ApiException {
    com.squareup.okhttp.Call call =
        getWorkflowsByNamesAndCorrelationIdsBeforeCall(
            request, includeClosed, includeTasks, null, null);
    Type localVarReturnType = new TypeReference<Map<String, List<Workflow>>>() {}.getType();
    ApiResponse<Map<String, List<Workflow>>> response = apiClient.execute(call, localVarReturnType);
    return response.getData();
  }

  private com.squareup.okhttp.Call getWorkflowsByNamesAndCorrelationIdsBeforeCall(
    ...
    if (request == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling getWorkflows1(Async)");
    }
    com.squareup.okhttp.Call call =
        getWorkflowsByNamesAndCorrelationIdsCall(
            request, includeClosed, includeTasks, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call getWorkflowsByNamesAndCorrelationIdsCall(
      CorrelationIdsSearchRequest body,
      Boolean includeClosed,
      Boolean includeTasks,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
  ...
  private com.squareup.okhttp.Call rerunValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        rerunCall(rerunWorkflowRequest, workflowId, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call restartValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        restartCall(workflowId, useLatestDefinitions, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call retryValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        retryCall(workflowId, resumeSubworkflowTasks, progressListener, progressRequestListener);
    return call;
  }
  ...
  public com.squareup.okhttp.Call searchCall(
    ...
    List<Pair> localVarQueryParams = new ArrayList<Pair>();
    List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
    if (queryId != null) localVarQueryParams.addAll(apiClient.parameterToPair("queryId", queryId));
   ...
   * sort&#x3D;&lt;field&gt;:ASC|DESC e.g. sort&#x3D;name&amp;sort&#x3D;workflowId:DESC. If order is
   * not specified, defaults to ASC.
   *
   * @param queryId (optional)
   * @param start (optional, default to 0)
   * @param size (optional, default to 100)
  ...
  private com.squareup.okhttp.Call searchV2ValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        searchV2Call(start, size, sort, freeText, query, progressListener, progressRequestListener);
    return call;
  }
  ...
  public SearchResultWorkflow searchV2(
      Integer start, Integer size, String sort, String freeText, String query) throws ApiException {
  ...
  private com.squareup.okhttp.Call searchWorkflowsByTasksValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        searchWorkflowsByTasksCall(
            start, size, sort, freeText, query, progressListener, progressRequestListener);
    return call;
  }
  ...
  private ApiResponse<SearchResultWorkflowSummary> searchWorkflowsByTasksWithHttpInfo(
      Integer start, Integer size, String sort, String freeText, String query) throws ApiException {
    com.squareup.okhttp.Call call =
        searchWorkflowsByTasksValidateBeforeCall(start, size, sort, freeText, query, null, null);
  ...
  private ApiResponse<SearchResultWorkflow> searchWorkflowsByTasksV2WithHttpInfo(
      Integer start, Integer size, String sort, String freeText, String query) throws ApiException {
    com.squareup.okhttp.Call call =
        searchWorkflowsByTasksV2ValidateBeforeCall(start, size, sort, freeText, query, null, null);
    Type localVarReturnType = new TypeReference<SearchResultWorkflow>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
  ...
  public com.squareup.okhttp.Call skipTaskFromWorkflowCall(
    ...
    if (skipTaskRequest != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("skipTaskRequest", skipTaskRequest));
  ...
  private com.squareup.okhttp.Call testWorkflowValidateBeforeCall(
    ...
    if (testRequest == null) {
      throw new ApiException(
          "Missing the required parameter 'testRequest' when calling testWorkflow");
    }

    com.squareup.okhttp.Call call =
        testWorkflowCall(testRequest, progressListener, progressRequestListener);
    return call;
  }
  ...
  private ApiResponse<Workflow> testWorkflowWithHttpInfo(WorkflowTestRequest testRequest)
      throws ApiException {
    com.squareup.okhttp.Call call = testWorkflowValidateBeforeCall(testRequest, null, null);
    Type localVarReturnType = new TypeReference<Workflow>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
  ...
  private ApiResponse<String> startWorkflow1WithHttpInfo(
      ...
      throws ApiException {
    com.squareup.okhttp.Call call =
        startWorkflow1ValidateBeforeCall(body, name, version, correlationId, priority, null, null);
    Type localVarReturnType = new TypeReference<String>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
  ...
  public com.squareup.okhttp.Call terminate1Call(
    ...
    localVarQueryParams.addAll(
        apiClient.parameterToPair("triggerFailureWorkflow", triggerFailureWorkflow));
  ...
  private com.squareup.okhttp.Call terminate1ValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        terminate1Call(
            workflowId, reason, triggerFailureWorkflow, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     response body
   */
  private ApiResponse<Void> terminate1WithHttpInfo(
      String workflowId, String reason, boolean triggerFailureWorkflow) throws ApiException {
    com.squareup.okhttp.Call call =
  ...
  /**
   * Upgrade running workflow to newer version Upgrade running workflow to newer version
   *
   * @param body (required)
   * @param workflowId (required)
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   ...
   *     response body
   */
  public ApiResponse<Void> upgradeRunningWorkflowWithHttpInfo(
      UpgradeWorkflowRequest body, String workflowId) throws ApiException {
    com.squareup.okhttp.Call call =
        upgradeRunningWorkflowValidateBeforeCall(body, workflowId, null, null);
    return apiClient.execute(call);
  }

  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call upgradeRunningWorkflowValidateBeforeCall(
      UpgradeWorkflowRequest body,
      String workflowId,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling upgradeRunningWorkflow(Async)");
    }
    // verify the required parameter 'workflowId' is set
    if (workflowId == null) {
      throw new ApiException(
          "Missing the required parameter 'workflowId' when calling upgradeRunningWorkflow(Async)");
    }

    com.squareup.okhttp.Call call =
        upgradeRunningWorkflowCall(body, workflowId, progressListener, progressRequestListener);
    return call;
  }
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call upgradeRunningWorkflowCall(
      UpgradeWorkflowRequest body,
      String workflowId,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
  ...
  /**
   * Update workflow and task status Updates the workflow variables, tasks and triggers evaluation.
   *
   ...
   *     response body
   */
  public WorkflowRun updateWorkflowState(
      ...
      throws ApiException {
    ApiResponse<WorkflowRun> resp =
        updateWorkflowAndTaskStateWithHttpInfo(
            updateRequest, requestId, workflowId, waitUntilTaskRef, waitForSeconds);
    return resp.getData();
  }
   ...
   *     response body
   */
  public ApiResponse<WorkflowRun> updateWorkflowAndTaskStateWithHttpInfo(
      WorkflowStateUpdate body,
      String requestId,
      String workflowId,
      String waitUntilTaskRef,
      Integer waitForSeconds)
      throws ApiException {
    com.squareup.okhttp.Call call =
        updateWorkflowAndTaskStateValidateBeforeCall(
            body, requestId, workflowId, waitUntilTaskRef, waitForSeconds, null, null);
    Type localVarReturnType = new TypeToken<WorkflowRun>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  public com.squareup.okhttp.Call updateWorkflowAndTaskStateCall(
      WorkflowStateUpdate body,
      String requestId,
      String workflowId,
      String waitUntilTaskRef,
  ...
  private com.squareup.okhttp.Call updateWorkflowAndTaskStateValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling updateWorkflowAndTaskState(Async)");
    }
    // verify the required parameter 'requestId' is set
    if (requestId == null) {
      throw new ApiException(
          "Missing the required parameter 'requestId' when calling updateWorkflowAndTaskState(Async)");
    }
    // verify the required parameter 'workflowId' is set
    if (workflowId == null) {
      throw new ApiException(
          "Missing the required parameter 'workflowId' when calling updateWorkflowAndTaskState(Async)");
    }

    com.squareup.okhttp.Call call =
        updateWorkflowAndTaskStateCall(
            body,
            requestId,
            workflowId,
            waitUntilTaskRef,
