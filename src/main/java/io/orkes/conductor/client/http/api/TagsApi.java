...
public class TagsApi {
  ...
  private ApiResponse<Void> addTaskTagWithHttpInfo(TagObject tagObject, String taskName)
      throws ApiException {
    com.squareup.okhttp.Call call = addTaskTagValidateBeforeCall(tagObject, taskName, null, null);
  ...
  private ApiResponse<Void> addWorkflowTagWithHttpInfo(TagObject tagObject, String name)
      throws ApiException {
    com.squareup.okhttp.Call call = addWorkflowTagValidateBeforeCall(tagObject, name, null, null);
    return apiClient.execute(call);
  }
  ...
  private ApiResponse<Void> setTaskTagsWithHttpInfo(List<TagObject> tagObjects, String taskName)
      throws ApiException {
    com.squareup.okhttp.Call call = setTaskTagsValidateBeforeCall(tagObjects, taskName, null, null);
    return apiClient.execute(call);
  }
  ...
  private ApiResponse<Void> setWorkflowTagsWithHttpInfo(List<TagObject> tagObjects, String name)
      throws ApiException {
    com.squareup.okhttp.Call call = setWorkflowTagsValidateBeforeCall(tagObjects, name, null, null);
    return apiClient.execute(call);
  }
}
