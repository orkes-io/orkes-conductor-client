...
public class SecretResourceApi {
  ...
  public com.squareup.okhttp.Call deleteSecretCall(
    ...
    String localVarPath =
        "/secrets/{key}".replaceAll("\\{" + "key" + "\\}", apiClient.escapeString(key.toString()));
  ...
  private com.squareup.okhttp.Call getSecretValidateBeforeCall(
    ...
    // verify the required parameter 'key' is set
    if (key == null) {
      throw new ApiException("Missing the required parameter 'key' when calling getSecret(Async)");
    }

    com.squareup.okhttp.Call call = getSecretCall(key, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call putSecretValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException("Missing the required parameter 'body' when calling putSecret(Async)");
    }
    // verify the required parameter 'key' is set
    if (key == null) {
      throw new ApiException("Missing the required parameter 'key' when calling putSecret(Async)");
    }
  ...
  private com.squareup.okhttp.Call putTagForSecretValidateBeforeCall(
      List<TagObject> body,
      String key,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling putTagForSecret(Async)");
    }
    // verify the required parameter 'key' is set
    if (key == null) {
      throw new ApiException(
          "Missing the required parameter 'key' when calling putTagForSecret(Async)");
    }

    com.squareup.okhttp.Call call =
        putTagForSecretCall(body, key, progressListener, progressRequestListener);
    return call;
  }
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  private com.squareup.okhttp.Call putTagForSecretCall(
      List<TagObject> body,
      String key,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
  ...
  private com.squareup.okhttp.Call deleteTagForSecretValidateBeforeCall(
      List<TagObject> body,
      String key,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling deleteTagForSecret(Async)");
    }
    // verify the required parameter 'key' is set
    if (key == null) {
      throw new ApiException(
          "Missing the required parameter 'key' when calling deleteTagForSecret(Async)");
    }

    com.squareup.okhttp.Call call =
        deleteTagForSecretCall(body, key, progressListener, progressRequestListener);
    return call;
  }
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  private com.squareup.okhttp.Call deleteTagForSecretCall(
      List<TagObject> body,
      String key,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  private com.squareup.okhttp.Call getTagsCall(
      String key,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
