...
public class MetadataResourceApi {
     ...
     */
    public void addWorkflowBusinessState(BusinessStateSchema body, String name) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteWorkflowBusinessStateForTypeCall(String body, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteWorkflowBusinessStateForTypeValidateBeforeCall(String body, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling deleteWorkflowBusinessStateForType(Async)");
        }
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling deleteWorkflowBusinessStateForType(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void deleteWorkflowBusinessStateForType(String body, String name) throws ApiException {
        deleteWorkflowBusinessStateForTypeWithHttpInfo(body, name);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteWorkflowBusinessStateForTypeWithHttpInfo(String body, String name) throws ApiException {
