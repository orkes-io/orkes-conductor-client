...
public class MetadataResourceApi {
  ...
  private ApiResponse<Void> createWithHttpInfo(WorkflowDef workflowDef, Boolean overwrite)
      throws ApiException {
    com.squareup.okhttp.Call call = createValidateBeforeCall(workflowDef, overwrite, null, null);
  ...
  private com.squareup.okhttp.Call getAllWorkflowsValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getAllWorkflowsCall(
            access, metadata, tagKey, tagValue, progressListener, progressRequestListener);
    return call;
  }
  ...
  private ApiResponse<Void> updateWithHttpInfo(List<WorkflowDef> workflowDefs, Boolean overwrite)
      throws ApiException {
    com.squareup.okhttp.Call call = updateValidateBeforeCall(workflowDefs, overwrite, null, null);
    return apiClient.execute(call);
  }
