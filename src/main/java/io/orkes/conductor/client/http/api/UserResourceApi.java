...
public class UserResourceApi {
   ...
   *     response body
   */
  private ApiResponse<List<ConductorUser>> listUsersWithHttpInfo(Boolean apps) throws ApiException {
  ...
  private ApiResponse<ConductorUser> upsertUserWithHttpInfo(
    ...
    com.squareup.okhttp.Call call = upsertUserValidateBeforeCall(upsertUserRequest, id, null, null);
    Type localVarReturnType = new TypeReference<ConductorUser>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
}
