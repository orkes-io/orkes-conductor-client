...
public class TaskResourceApi {
  ...
  public com.squareup.okhttp.Call batchPollCall(
    ...
    if (timeout != null) localVarQueryParams.addAll(apiClient.parameterToPair("timeout", timeout));
  ...
  private com.squareup.okhttp.Call batchPollValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        batchPollCall(
            tasktype, workerid, domain, count, timeout, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call getAllPollDataValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = getAllPollDataCall(progressListener, progressRequestListener);
    return call;
  }
  ...
  private ApiResponse<ExternalStorageLocation> getExternalStorageLocation1WithHttpInfo(
      String path, String operation, String payloadType) throws ApiException {
    com.squareup.okhttp.Call call =
        getExternalStorageLocation1ValidateBeforeCall(path, operation, payloadType, null, null);
   ...
   *     response body
   */
  private ApiResponse<List<PollData>> getPollDataWithHttpInfo(String taskType) throws ApiException {
  ...
  private com.squareup.okhttp.Call logValidateBeforeCall(
    ...
    // verify the required parameter 'taskId' is set
    if (taskId == null) {
      throw new ApiException("Missing the required parameter 'taskId' when calling log(Async)");
    }
  ...
  private com.squareup.okhttp.Call pollValidateBeforeCall(
    ...
    // verify the required parameter 'tasktype' is set
    if (tasktype == null) {
      throw new ApiException("Missing the required parameter 'tasktype' when calling poll(Async)");
    }
  ...
  private ApiResponse<Task> pollWithHttpInfo(String tasktype, String workerid, String domain)
      throws ApiException {
    com.squareup.okhttp.Call call = pollValidateBeforeCall(tasktype, workerid, domain, null, null);
    Type localVarReturnType = new TypeReference<Task>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   *     response body
   */
  private ApiResponse<String> requeuePendingTaskWithHttpInfo(String taskType) throws ApiException {
  ...
  public SearchResultTask searchV21(
      Integer start, Integer size, String sort, String freeText, String query) throws ApiException {
    ApiResponse<SearchResultTask> resp = searchV21WithHttpInfo(start, size, sort, freeText, query);
    return resp.getData();
  }
  ...
  private com.squareup.okhttp.Call sizeValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = sizeCall(taskType, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call updateTaskByRefNameCall(
    ...
    // create path and map variables
    String localVarPath =
        path.replaceAll("\\{" + "workflowId" + "\\}", apiClient.escapeString(workflowId.toString()))
            .replaceAll(
                "\\{" + "taskRefName" + "\\}", apiClient.escapeString(taskRefName.toString()))
  ...
  private com.squareup.okhttp.Call updateTask1ValidateBeforeCall(
      Map<String, Object> body, String workflowId, String taskRefName, String status, boolean sync)
      throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(
    ...
    com.squareup.okhttp.Call call =
        updateTaskByRefNameCall(body, workflowId, taskRefName, status, getIdentity(), sync);
    return call;
  }
  ...
  public String updateTask1(
    ...
    ApiResponse<String> resp =
        updateTask1WithHttpInfo(body, workflowId, taskRefName, status, false, localVarReturnType);
    return resp.getData();
  }
   ...
   *     response
   */
  public String updateTaskByRefName(
      Map<String, Object> output, String workflowId, String taskRefName, String status)
      throws ApiException {
    Type localVarReturnType = new TypeReference<String>() {}.getType();
    ApiResponse<String> resp =
        updateTask1WithHttpInfo(output, workflowId, taskRefName, status, false, localVarReturnType);
    return resp.getData();
  }
  ...
  public Workflow updateTaskSync(
    ...
    ApiResponse<Workflow> resp =
        updateTask1WithHttpInfo(output, workflowId, taskRefName, status, true, localVarReturnType);
    return resp.getData();
  }
   ...
   *     response body
   */
  private <T> ApiResponse<T> updateTask1WithHttpInfo(
      Map<String, Object> body,
      String workflowId,
      String taskRefName,
      String status,
  ...
  private ApiResponse<Workflow> updateTaskSyncWithHttpInfo(
      Map<String, Object> body, String workflowId, String taskRefName, String status, boolean sync)
      throws ApiException {
    com.squareup.okhttp.Call call =
        updateTask1ValidateBeforeCall(body, workflowId, taskRefName, status, sync);
