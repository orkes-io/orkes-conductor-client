...
public class AuthorizationResourceApi {
   ...
   *     response body
   */
  private ApiResponse<Map<String, List<Subject>>> getPermissionsWithHttpInfo(String type, String id)
      throws ApiException {
  ...
  private com.squareup.okhttp.Call grantPermissionsValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        grantPermissionsCall(authorizationRequest, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call removePermissionsValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        removePermissionsCall(authorizationRequest, progressListener, progressRequestListener);
    return call;
  }
