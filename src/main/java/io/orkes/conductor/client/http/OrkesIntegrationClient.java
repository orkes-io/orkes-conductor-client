...
public class OrkesIntegrationClient extends OrkesClient implements IntegrationClient {
  ...
  public void associatePromptWithIntegration(
      String aiIntegration, String modelName, String promptName) {
  ...
  public IntegrationApi getIntegrationApi(String apiName, String integrationName)
      throws ApiException {
    try {
  ...
  public void saveIntegrationApi(
      String integrationName, String apiName, IntegrationApiUpdate apiDetails) {
