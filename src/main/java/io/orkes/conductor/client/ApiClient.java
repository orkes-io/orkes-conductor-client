...
public class ApiClient {
    ...
    public ApiClient(String basePath) {
        ...
        verifyingSsl = true;
        json = Mappers.GSON_AUTOGENERATED;
    ...
    public JSON getJSON() {
        if(json instanceof JSON) {
            return (JSON) json;
        } else throw new UnsupportedOperationException("Only supported for JSON");
     ...
     * Set JSON
     *
     * @param jsonMapper JSONMapper object
     * @return Api client
     */
    public ApiClient setJSONMapper(JSONMapper jsonMapper) {
    ...
    public ApiClient setDateFormat(DateFormat dateFormat) {
        if(json instanceof JSON) {
            ((JSON)json).setDateFormat(dateFormat);
            return this;
        } else throw new UnsupportedOperationException("Only supported for JSON");
    }
    ...
    public ApiClient setSqlDateFormat(DateFormat dateFormat) {
        if(json instanceof JSON) {
            ((JSON)json).setSqlDateFormat(dateFormat);
            return this;
        } else throw new UnsupportedOperationException("Only supported for JSON");
    }
    ...
    public ApiClient setOffsetDateTimeFormat(DateTimeFormatter dateFormat) {
        if(json instanceof JSON) {
            ((JSON)json).setOffsetDateTimeFormat(dateFormat);
            return this;
        } else throw new UnsupportedOperationException("Only supported for JSON");
    }
    ...
    public ApiClient setLocalDateFormat(DateTimeFormatter dateFormat) {
        if(json instanceof JSON) {
            ((JSON)json).setLocalDateFormat(dateFormat);
            return this;
        } else throw new UnsupportedOperationException("Only supported for JSON");
    }
    ...
    public ApiClient setLenientOnJson(boolean lenientOnJson) {
        if(json instanceof JSON) {
            ((JSON)json).setLenientOnJson(lenientOnJson);
            return this;
        } else throw new UnsupportedOperationException("Only supported for JSON");
    }
