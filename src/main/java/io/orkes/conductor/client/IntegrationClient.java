...
public interface IntegrationClient {
  /**
   * Client for managing integrations with external systems. Some examples of integrations are: 1.
   * AI/LLM providers (e.g. OpenAI, HuggingFace) 2. Vector DBs (Pinecone, Weaviate etc.) 3. Kafka 4.
   * Relational databases
   *
   * <p>Integrations are configured as integration -> api with 1->N cardinality. APIs are the
   * underlying resources for an integration and depending on the type of integration they represent
   * underlying resources. Examples: LLM integrations The integration specifies the name of the
   * integration unique to your environment, api keys and endpoint used. APIs are the models (e.g.
   * text-davinci-003, or text-embedding-ada-002)
   *
   * <p>Vector DB integrations, The integration represents the cluster, specifies the name of the
   * integration unique to your environment, api keys and endpoint used. APIs are the indexes (e.g.
   * pinecone) or class (e.g. for weaviate)
   *
   * <p>Kafka The integration represents the cluster, specifies the name of the integration unique
   * to your environment, api keys and endpoint used. APIs are the topics that are configured for
   * use within this kafka cluster
   */
