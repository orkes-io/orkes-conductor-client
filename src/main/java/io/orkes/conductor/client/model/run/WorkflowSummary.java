...
import io.orkes.conductor.client.model.run.Workflow.WorkflowStatus;
...
public class WorkflowSummary {
    ...
    public WorkflowSummary(Workflow workflow) {
        ...
        if (workflow.getInput() != null) {
            // TODO use SummaryUtil.serializeInputOutput
            this.input = json.serialize(workflow.getInput());
        }
        if (workflow.getOutput() != null) {
            this.output = json.serialize(workflow.getOutput());
        }
