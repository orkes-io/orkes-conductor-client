...
public interface PromptClient {
  ...
  /**
   * Tests a prompt template by substituting variables and processing through the specified AI
   * model.
   *
   ...
   * @param topP the probability mass to consider from the output distribution (optional, default is
   *     0.9)
  ...
  String testPrompt(
      ...
      String aiIntegration,
      String textCompleteModel,
      float temperature,
      float topP,
