...
public abstract class WorkflowClient extends com.netflix.conductor.client.http.WorkflowClient {
    ...
    public abstract Map<String, Object> executeWorkflowAsGetApi(StartWorkflowRequest request, String waitUntilTask, Integer waitForSeconds, String authorization);
    public abstract Map<String, Object> executeWorkflowAsApi(StartWorkflowRequest request, String waitUntilTask, Integer waitForSeconds, String authorization);
