 ...
 */
package io.orkes.conductor.sdk.workflow.executor.task;
...
import io.orkes.conductor.sdk.workflow.def.tasks.DynamicForkInput;
import io.orkes.conductor.sdk.workflow.task.InputParam;
import io.orkes.conductor.sdk.workflow.task.OutputParam;
...
public class AnnotatedWorker implements Worker {
    ...
    private TaskResult setValue(Object invocationResult, TaskResult result) {
        ...
        if (opAnnotation != null) {
            ...
            List<io.orkes.conductor.sdk.workflow.def.tasks.Task<?>> tasks = forkInput.getTasks();
            List<WorkflowTask> workflowTasks = new ArrayList<>();
            for (io.orkes.conductor.sdk.workflow.def.tasks.Task<?> sdkTask : tasks) {
