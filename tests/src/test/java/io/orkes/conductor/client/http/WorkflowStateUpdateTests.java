...
public class WorkflowStateUpdateTests extends ClientTest {
    ...
    public void test() {
        ...
        Assertions.assertEquals(1, allTaskStatus.size());
        Assertions.assertEquals(Task.Status.COMPLETED, allTaskStatus.iterator().next());
    ...
    public void testIdempotency() {
        ...
        Assertions.assertEquals(workflowId, workflowId2);
