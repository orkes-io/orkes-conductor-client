...
public class WorkflowClientTests extends ClientTest {
    ...
    public static void setup() {
        workflowClient = ClientTest.orkesClients.getWorkflowClient();
        metadataClient = ClientTest.orkesClients.getMetadataClient();
        workflowExecutor = new WorkflowExecutor(
                ClientTest.orkesClients.getTaskClient(),
                ClientTest.orkesClients.getWorkflowClient(),
                ClientTest.orkesClients.getMetadataClient(),
                10);
    }
    ...
    public void startWorkflow() {
        ...
        Assertions.assertTrue(workflow.getWorkflowName().equals(Commons.WORKFLOW_NAME));
    }
    ...
    public void testUpdateVariables() {
        ...
        Assertions.assertNotNull(execution);
        Assertions.assertFalse(execution.getVariables().isEmpty());
        Assertions.assertEquals(null, execution.getVariables().get("k1"));
        Assertions.assertEquals(variables.get("k2").toString(), execution.getVariables().get("k2").toString());
        Assertions.assertEquals(variables.get("k3").toString(), execution.getVariables().get("k3").toString());
